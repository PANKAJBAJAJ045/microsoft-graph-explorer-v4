...
export const fetchSamplesSuccess = (response: object): AppAction => {
  return {
...
export const fetchSamplesError = (response: object): AppAction => {
  return {
...
export const fetchSamplesPending = (): AppAction => {
  return {
